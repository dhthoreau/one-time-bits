...
void otb_protocol_execute(OtbProtocolContext *protocol_context, ProtocolFunc protocol_func, GInputStream *input_stream, GOutputStream *output_stream, gboolean initiate_communication);	// FARE - Unit test server.
