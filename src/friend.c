...
{
	otb_settings_set_bytes(export_file, OTB_FRIEND_IMPORT_GROUP, OTB_FRIEND_IMPORT_UNIQUE_ID, otb_unique_id_get_bytes(friend->priv->unique_id), OTB_UNIQUE_ID_BYTES_LENGTH);
