...
static void otb_assert_pads_appropriate_deleted_by_client_after_server_sends_pad_ids_to_client(const int initial_pad_counts[3], const OtbPadDb *outgoing_pad_db, OtbUniqueId *expected_pad_ids[2])
{
